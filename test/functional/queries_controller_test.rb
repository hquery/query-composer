...
class QueriesControllerTest < ActionController::TestCase
  ...
  setup  do 
    ...
    @endpoints_for_execution << FactoryGirl.create(:endpoint, base_url: 'https://127.0.0.1:3002')
  ...
  test "should execute query with notification" do
    sign_in @user
    FakeWeb.register_uri(:post, "https://127.0.0.1:3001/queries", :body => "FORCE ERROR")
  ...
  test "should cancel endpoint results" do
    sign_in @user
    FakeWeb.register_uri(:post, "https://127.0.0.1:3001/queries", :body => "{}", :status => ["304"], :location=>"https://localhost:3001/queries")
    query_from_db = Query.find(@ids[2])
